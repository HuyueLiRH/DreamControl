...
from isaaclab_tasks.manager_based.motion_tracking.g1.motion_tracking_env import joint_deviation_ref_l1, orientation_tracking_error, target_orientation_error, target_ref, root_below_threshold, root_angle_below_threshold, current_time_enc, reset_root_state_for_motion
import numpy as np
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        rel_pose_object = ObsTerm(func=rel_pose_object, params={"fix_rel_base_height": True, "base_height": 0.753})
...
@configclass
class G1PickUBRealEnvCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.ref_motions_path = "../TrajGen/sample/Pick_real2"
...
@configclass
class G1PickUBRealEnvEvalCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
...
@configclass
class G1PickUBRealEnvPlayCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
    commands: CommandsCfg_eval = CommandsCfg_eval()
    events: EventCfg = EventCfg()
    observations: ObservationsCfg = ObservationsCfg()
    ...
    def __post_init__(self):
        ...
        self.scene.camera = CameraCfg(prim_path="{ENV_REGEX_NS}/Camera_new",
                                      ...
                                      offset=CameraCfg.OffsetCfg(
                                          pos=(-2.33+2.1-0.034, -4.45+0.9, 1.81),
        ...
        self.scene.kitchen = AssetBaseCfg(
            ...
            spawn=sim_utils.UsdFileCfg(usd_path="assets/HQ Kitchen/Collected_kitchen_flat/kitchen_flat.usd",scale=(1.,1.,.89)),
            init_state=AssetBaseCfg.InitialStateCfg(pos=(0.36, 0.9, 0.), rot=(1, 0, 0, 0)),
        )
