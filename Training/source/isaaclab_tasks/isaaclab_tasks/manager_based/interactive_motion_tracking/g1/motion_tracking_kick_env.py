...
class G1Rewards(G1RewardsBase):
    ...
    feet_parallel_to_ground_right = RewTerm(
        func=mdp.feet_parallel_to_ground,
        weight=-.3,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=["right_ankle_roll_link"]),
...
@configclass
class G1KickEnvCfg(G1InteractiveBaseEnvCfg):
...
class G1KickEnvPlayCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.gym = AssetBaseCfg(
            ...
            init_state=AssetBaseCfg.InitialStateCfg(pos=(2.1+2.75776*0.7, 13.35736*0.7+0.6, 0.001), rot=(0, 0, 0, 1)),
        )
