...
def add_base_options(parser):
    ...
    group.add_argument("--task", default="pick", type=str, help="Task to perform. Choose from pick, pick_place, sit, open_drawer, jump, kick, punch, button_press, ground_pick, bimanual_pick, ground_pick_new.")
