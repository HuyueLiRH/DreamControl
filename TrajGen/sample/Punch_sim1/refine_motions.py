...
for pkl_path in pkl_paths:
    ...
    with open(SAVE_DIR + pkl_path[:-4] + "_n.pkl","wb") as f:
        pickle.dump({"global_pose": Ts_world_root , "joints": joints_new, "global_position": trans_new, "punch_pos": motion_data["punch_pos"], "grab_idx": motion_data["grab_idx"]+PAUSE_AMT+INTERP_AMT}, f)
