...
def main():
    ...
    if args.text_prompt != '':
        if args.text_prompt == 'predefined':
            ...
            texts, hints = collate_all(n_frames, args.dataset, args.task)
    ...
    print("Is model using data?", is_using_data)
    ...
    np.save(npy_path, {'motion': all_motions, 'text': all_text, 'lengths': all_lengths, "hint": all_hint_for_vis, 'num_samples': args.num_samples, 'num_repetitions': args.num_repetitions})
