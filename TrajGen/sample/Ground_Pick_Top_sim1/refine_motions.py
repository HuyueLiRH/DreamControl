...
with open(SAVE_DIR + pkl_path[:-4] + "_n.pkl","wb") as f:
    pickle.dump({"global_pose": Ts_world_root , "joints": joints_new, "global_position": trans_new, "ground_grab_pos_new": motion_data["ground_grab_pos"], "grab_idx": motion_data["grab_idx"]+PAUSE_AMT+INTERP_AMT}, f)
