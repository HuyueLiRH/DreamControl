...
TASK_NAME = "Ground_Pick_Top_sim1"
...
def main():
    ...
    hints = DATA['hint'][2:3,1:]
    smpl_keypoints_ = DATA['motion'][2:3].transpose((0,3,1,2)) # Shape: (k, N, 22, 3)
    ...
    for i in range(num_motions):
        ...
        global_position[65:] = global_position[65:66]
        global_orientation[65:] = global_orientation[65:66]
        jointss[i][65:] = jointss[i][65:66]
        ...
        with open("../"+TASK_NAME+ "/" + str(i) + ".pkl", "wb") as f:
            pickle.dump({"global_pose": global_pose , "joints": jointss[i], "global_position": global_position, "ground_grab_pos": grab_pos , "grab_idx": pick_t}, f)
